    ...
    <div className="h-screen overflow-hidden bg-gradient-to-br from-background via-accent/30 to-background flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-6xl flex items-center gap-12">
        ...
        <div className="flex-1 text-center">
          ...
          <h1 className="text-4xl font-bold text-foreground mb-4">Join OneOps</h1>
          <p className="text-xl text-muted-foreground">Create your account and start your DevOps journey</p>
        </div>
